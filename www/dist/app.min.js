...
DashCtrl.$inject = ["$ionicPopup", "$scope", "activityService", "historyService", "activityTimingService", "$filter", "preferenceService", "newActivityService", "toastService", "$ionicPopover", "$state", "appName"];
angular.module('tracker')

...
angular.module('tracker')
  ...
  .config(["$ionicConfigProvider", "$mdGestureProvider", function($ionicConfigProvider, $mdGestureProvider) {
...
ActivityCtrl.$inject = ["$ionicPopup", "$scope", "activityService", "historyService", "activityTimingService", "$filter", "preferenceService", "popupService"];
angular.module('tracker')
...
AddActivityCtrl.$inject = ["activityService", "$state", "newActivityService"];
angular.module('tracker')
...
DashboardEditCtrl.$inject = ["activityService"];
angular.module('tracker')
...
AuthenticationService.$inject = ["$http", "API", "$ionicPopup", "$cordovaToast", "EventSendService"];
angular.module('tracker')
...
NotificationService.$inject = ["$ionicPlatform"];
...
popupService.$inject = ["$ionicPopup", "$rootScope", "activityService"];
angular.module('tracker')

...
DashCtrl.$inject = ["$ionicPopup", "$scope", "activityService", "historyService", "activityTimingService", "$filter", "preferenceService", "newActivityService", "toastService", "$ionicModal", "$state", "appName"];
angular.module('tracker')

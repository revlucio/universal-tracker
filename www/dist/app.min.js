...
countdownActivity.$inject = ["activityTimingService", "$ionicPopup", "$rootScope", "durationService", "historyService", "toastService"];
angular.module('tracker')
...
durationActivity.$inject = ["$ionicPopup", "$rootScope", "activityTimingService", "historyService", "$filter", "toastService", "durationService"];
angular.module('tracker')
...
multiActivity.$inject = ["$ionicPopup", "$rootScope", "toastService", "historyService", "preferenceService"];
angular.module('tracker')
...
singleActivity.$inject = ["$rootScope", "$ionicPopup", "historyService", "toastService"];
angular.module('tracker')
...
AddCtrl.$inject = ["activityService", "$state", "newActivityService", "durationService"];
angular.module('tracker')
...
DashCtrl.$inject = ["$scope", "activityService", "newActivityService", "$ionicPopover", "$state", "appName"];
angular.module('tracker')
...
historyService.$inject = ["preferenceService", "oneSelfService", "toastService"];
angular.module('tracker')
...
activityTimingService.$inject = ["moment", "$interval", "NotificationService", "historyService", "toastService", "$filter"];
angular.module('tracker')
